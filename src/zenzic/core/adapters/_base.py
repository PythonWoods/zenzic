...
class ContentRoot:
    ...
    Introduced in v0.7.x (Multi-Root Discovery) to fix the *VSM Blindness*
...
class VirtualRoute:
    ...
    Introduced in v0.7.x (Virtual Frontier) to solve *Virtual Route Blindness*:
...
class BaseAdapter(Protocol):
    ...
    def get_metadata_files(self) -> frozenset[str]:
        ...
        excluded from Z903 (Unused Asset) and other quality checks.  Return
