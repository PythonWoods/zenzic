...
COMMANDS: tuple[CommandMeta, ...] = (
    CommandMeta(
        name="lab",
        panel="Core",
        short_help="Zenzic Lab — interactive showcase of bundled documentation examples.",
    ...
    CommandMeta(
        name="check",
        panel="Core",
        short_help="Check — Run documentation quality checks.",
    ...
    CommandMeta(
        name="clean",
        panel="Core",
        short_help="Clean — Safely remove unused documentation files.",
    ...
    CommandMeta(
        name="config",
        panel="Introspection",
        short_help="Config — Inspect the active Zenzic configuration and the origin of each value.",
    ...
    CommandMeta(
        name="guard",
        panel="Introspection",
        short_help="Guard — Fast pre-commit secret guard for Markdown/MDX files.",
    ...
    CommandMeta(
        name="inspect",
        panel="Introspection",
        short_help="Inspect — Introspect the Zenzic scanner arsenal and plugin registry.",
