...
This directory contains per-minor-version changelog archives for Zenzic.
For the current release history, see the [main Changelog](../CHANGELOG.md).

| Version | Codename | Period | Archive |
|---------|----------|--------|---------|
| v0.1.x | — | 2026-03-18 | [v0.1.md](./v0.1.md) |
| v0.2.x | — | 2026-03-23 | [v0.2.md](./v0.2.md) |
