...
All notable changes to Zenzic in the v0.19.x series are documented here.
This series introduced the lossless AST foundations, the Atomic Auto-Fix engine,
and the Polyglot Extractor security hardening campaign.
