...
# Z303 — Duplicate Definition Gallery Example

This page defines the same reference ID twice,
demonstrating **Z303 DUPLICATE_DEF** detection.

## API Reference

See the [API documentation][api] for endpoint details.
